...
<a href="https://frontend-cntjdus1.vercel.app/product/1">
  <img src="https://img.shields.io/badge/ENTER_MCM_TAP_ATELIER-000000?style=for-the-badge&logo=vercel&logoColor=white" />
</a>
...
<img src="https://img.shields.io/badge/Kakao-FFCD00?style=flat-square&logo=kakao&logoColor=000000"/>
...
```mermaid
flowchart TD
    A["NFC TAP Product"] --> D["AI Stylist"]
    B["Today's Items"] --> D
    C["Style Preference"] --> D
...
```mermaid
flowchart TB
    NFC["NFC TAG"] --> WEB["MCM TAP ATELIER WEB"]
    ...
    PRODUCT --> COMPARE["Size Compare"]
    PRODUCT --> STORY["Product Story"]

    AI --> PROFILE["Style Profile"]
    AI --> LOOK["3 Curated Looks"]

    MY --> SAVE["Save & Continue"]
    MY --> SHARE["Share"]

    ADVISOR --> SESSION["Private Session"]

    INFO --> API["Backend API"]
    COMPARE --> API
    PROFILE --> API
    LOOK --> API
    SAVE --> API
...
<img src="https://img.shields.io/badge/Responsive_Web-000000?style=for-the-badge"/>
<img src="https://img.shields.io/badge/Mobile_First-111111?style=for-the-badge"/>
...
<img src="https://img.shields.io/badge/Kakao_SDK-FFCD00?style=for-the-badge&logo=kakao&logoColor=000000"/>
<img src="https://img.shields.io/badge/NFC-000000?style=for-the-badge&logo=nfc&logoColor=white"/>
...
```mermaid
journey
    title MCM TAP ATELIER Customer Journey
    section Discover
      Find MCM Product: 5: Customer
      NFC TAP: 5: Customer
    section Explore
      View Product Details: 5: Customer
      Compare Sizes: 4: Customer
      Explore Product Story: 5: Customer
    section Personalize
      Analyze Style: 5: AI
      View Curated Looks: 5: Customer
    section Connect
      Request Private Session: 4: Customer
      Receive Professional Support: 5: Advisor
    section Continue
      Save Product: 5: Customer
      Review After Visit: 5: Customer
```
...
```mermaid
flowchart LR
    A["Phase 01<br/>Selected Products"] --> B["Phase 02<br/>Selected Category"]
    B --> C["Phase 03<br/>Entire Store"]
    C --> D["Phase 04<br/>CRM Integration"]
    D --> E["Phase 05<br/>Omnichannel Experience"]
```
...
<a href="https://frontend-cntjdus1.vercel.app/product/1">
  <img src="https://img.shields.io/badge/MCM_TAP_ATELIER-LIVE-000000?style=for-the-badge&logo=vercel&logoColor=white" />
</a>
